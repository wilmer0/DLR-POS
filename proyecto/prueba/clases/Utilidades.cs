    ...
    public  class Utilidades
    {
        ...
        private  static void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                //detalles_factura,efectivo,devuelta,tarjeta,cheque,codigoTipoComprobante,deposito
        ...
        public static bool backupSql(string rutaDestino, string database)
        {
            try
            {
                string sql = "exec backup_sistema '"+@"C:\Users\wilmer\Desktop\utesa\proyecto3\backups\"+"','punto_venta'";
                ejecutarcomando(sql);
                return true;
            }
            catch (Exception ex)
