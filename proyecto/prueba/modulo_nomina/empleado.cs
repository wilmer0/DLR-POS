                                                                    ...
                                                                    if (codigo_tipo_nomina_txt.Text.Trim() != "")
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            DataSet ds = Utilidades.ejecutarcomando(sql);
                                                                                ...
                                                                                string clavee = Utilidades.encriptar(clave_txt.Text.Trim());
                                                                           /*alter proc insert_empleado @nombre varchar(50),@apellido varchar(50),@identificacion varchar(11),                                                      @cod_sexo int, @fecha_nacimiento date,                                                      @login varchar(30),@clave varchar(30),@sueldo float,@cod_situacion int, @cod_sucursal int,                                                                                                          @cod_departamento int,@cod_cargo int,@cod_cliente int,@estado bit,@cod_empleado int,@cod_grupo_usuario int,@fecha_ingreso date,@cod_tipo_nomina int,@cod_tercero_modificar int */
